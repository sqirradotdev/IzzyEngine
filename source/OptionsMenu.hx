...
class OptionsMenu extends MusicBeatState
{
	...
	var inputStr:Array<String> = ["W A S D", "D F J K"];
		...
		super.update(elapsed);
			...
			switch (curSelected)
			{
				case 1:
					...
					add(info);
				case 4:
					var infoTxt:String = "Only acts on unpog Input";
			...
			if (controls.ACCEPT)
			{
				...
				switch(curSelected)
				{
					...
					case 1:
						...
						var ctrl:Alphabet = new Alphabet(0, (70 * curSelected) + 30, (FlxG.save.data.newInput ? "UnPog input easy" : "Pog input normal"), true, false);
						ctrl.isMenuItem = true;
